...
사실 이 방법도 완벽한 구성은 아닙니다. 최근에는 Claude의 Remote Control 기능이나, 모바일 메신저를 MCP로 연결하는 사례들이 빠르게 늘고 있습니다. 카카오톡이나 텔레그램에서 바로 AI한테 명령을 보내고, PC 쪽에서 자동으로 실행되는 흐름이 안정화되면 Termux에서 직접 돌리는 이 방식은 금방 대체될 수 있다고 생각합니다. 지금은 그런 도구들이 충분히 성숙하지 않았기 때문에 이렇게 쓰고 있는 것에 가깝습니다.

그래도 **지금 당장 쓸 수 있는 방법**이라는 점에서는 의미가 있었습니다. 오래 만들어보고 싶었던 환경을 일단 갖추게 된 것만으로도 충분했습니다.
